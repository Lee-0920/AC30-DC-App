...
#define CMD_TABLE_SOLENOID_VALVE \
	...
	DSCP_CMD_ENTRY(DSCP_CMD_SVI_GET_CURRENT_TEMPERATURE, SolenoidVale_GetTemperature),\
	DSCP_CMD_ENTRY(DSCP_CMD_SVI_GET_LIQUID_SENSOR_MAP, SolenoidVale_GetLiquidSensorsMap)
