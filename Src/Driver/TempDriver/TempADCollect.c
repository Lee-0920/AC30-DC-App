...
#define ADCx_CHANNELA_GPIO_CLK    RCC_AHB1Periph_GPIOA
#define ADCx_CHANNELB_GPIO_CLK    RCC_AHB1Periph_GPIOA
#define ADCx_CHANNELC_GPIO_CLK    RCC_AHB1Periph_GPIOC
#define ADC_CHANNELA              ADC_Channel_6	//温度采集AD通道
#define ADC_CHANNELB              ADC_Channel_7   //漏液采集AD通道
#define ADC_CHANNELC              ADC_Channel_10   //定量点AD检测

#define GPIO_CHANNELA_PIN         GPIO_Pin_6		//漏液采集引脚
#define GPIO_CHANNELA_PORT        GPIOA
#define GPIO_CHANNELB_PIN         GPIO_Pin_7	//漏液采集引脚
#define GPIO_CHANNELB_PORT        GPIOA
#define GPIO_CHANNELC_PIN         GPIO_Pin_0		//定量点采集引脚
...
{
    RCC_AHB1PeriphClockCmd(ADCx_CHANNELA_GPIO_CLK | ADCx_CHANNELB_GPIO_CLK | ADCx_CHANNELC_GPIO_CLK, ENABLE);
